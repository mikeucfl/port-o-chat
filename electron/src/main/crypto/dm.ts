...
/** Static-static ECDH -> HKDF. No forward secrecy — see CRYPTO.md (this is a deliberate, documented non-goal). */
export function deriveDmKey(
  ...
  const shared = deriveSharedSecret(myPrivateKey, rawPublicKeyToKeyObject(peerPublicKeyRaw))
